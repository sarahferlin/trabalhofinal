...
# Calcula número de municípios Litoral Centro

n_mun_lc <- length(unique(dados_lc$municipio))
...
nup_total_lc <- (agg.nviagens_lc <- aggregate(dados_lc$n_ups~dados_lc$localidade, FUN=sum))
