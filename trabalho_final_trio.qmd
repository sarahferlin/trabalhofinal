...
# filtrar só dados do Litoral Norte

dados_ln <-  dados %>% filter(., `localidade` == "Litoral Norte")

# número de municípios Litoral Norte

n_municipios_ln <- length(unique(dados_ln$municipio))


# número de total de viagens no Litoral Norte

nviagens_ln <- (agg.nviagens_ln <- aggregate(dados_ln$n_descargas~dados_ln$localidade, FUN=sum))
